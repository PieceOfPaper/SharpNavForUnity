...
public class SharpNavExample : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        setting.AgentRadius = 0.01f;
        setting.CellSize = 0.01f;
    ...
    private void OnDrawGizmos()
    {
        ...
        // if (navMesh != null && path != null)
        // {
        //     for (int pathIndex = 0; pathIndex < path.Count; pathIndex ++)
        //     {
        //         var polyRef = path[pathIndex];
        //         SharpNav.Pathfinding.NavTile tile;
        //         SharpNav.Pathfinding.NavPoly poly;
		// 		navMesh.TryGetTileAndPolyByRefUnsafe(polyRef, out tile, out poly);

        //         for (int vertIndex = 2; vertIndex < SharpNav.Pathfinding.PathfindingCommon.VERTS_PER_POLYGON; vertIndex++)
        //         {
        //             if (poly.Verts[vertIndex] == 0)
        //                 break;

        //             int vertIndex0 = poly.Verts[0];
        //             int vertIndex1 = poly.Verts[vertIndex - 1];
        //             int vertIndex2 = poly.Verts[vertIndex];
